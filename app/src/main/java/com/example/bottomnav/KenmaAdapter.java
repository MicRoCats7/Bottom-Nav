...
private ArrayList<Kenma> kenma;
    ...
    @NonNull
    @Override
    public KenmaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(parent.getContext(), R.layout.kenmaimage, null);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull KenmaAdapter.ViewHolder holder, int position) {
